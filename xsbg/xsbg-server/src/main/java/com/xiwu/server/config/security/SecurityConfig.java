package com.xiwu.server.config.security;

import com.xiwu.server.config.security.component.*;
import com.xiwu.server.pojo.Admin;
//import com.xiwu.server.service.AdminService;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    // 1重写 UserDetailsService，用我们自己写的业务逻辑
    @Override
    @Bean
